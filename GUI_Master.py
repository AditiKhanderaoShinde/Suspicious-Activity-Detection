...
heading = tk.Label(root,text="Suspicious Activity Detection",width=40,font=("Times New Roman",45,'bold'),bg="#192841",fg="white")
heading.place(x=0,y=0)

def mail():
    SENDER_EMAIL = "varun.chaudhari3451@gmail.com"
    APP_PASSWORD = "xqis bbsx wdnd frgw"
    ...
    msg['To'] = "aditishinde290@gmail.com"
...
import pyttsx3
import winsound
def beep(duration_ms=1000, frequency=1000):
...
def show_FDD_video(video_path):
    ...
    while True:
        ...
        if  label == 1 :
            ...
            color = red
            mail()
            speak("Suspicious activity detected!") 
            beep()
...
button5 = tk.Button(root,command = Video_Verify, text="Suspicious Activity", width=20,font=("Times new roman", 20, "bold"),bg="gray",fg="black")
button5.place(x=100,y=150)

# button5 = tk.Button(root,command = train_model, text="Train", width=20,font=("Times new roman", 20, "bold"),bg="gray",fg="black")
# button5.place(x=100,y=350)

close = tk.Button(root,command = CLOSE, text="Exit", width=15,font=("Times new roman", 20, "bold"),bg="red",fg="white")
close.place(x=130,y=250)
